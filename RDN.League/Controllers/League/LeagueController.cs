...
, new Guid(leagueId)))
                        ...
                        foreach (var item in items)
                        {
                            if (!String.IsNullOrEmpty(item))
                            {
                                ...
                                if (Enum.GetNames(typeof(MemberContactTypeEnum)).Contains(item))
                                {
                                    ...
                                    ExcelWorksheet reportSheet_contact = p.Workbook.Worksheets.Add(item);
        ...
        public ExcelWorksheet PrepareContactTypeSheet(ExcelWorksheet contactSheet, MemberContactTypeEnum contacttype)
        {
