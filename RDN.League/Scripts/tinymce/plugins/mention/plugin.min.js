    ...
    AutoComplete.prototype = {
        ...
        bindEvents: function () {
            ...
            this.editor.on("keyup", function () {
                auto_complete.rteKeyUp(this);
            });
            this.editor.on("keydown",function () { this.editorKeyDownProxy = $.proxy(auto_complete.rteKeyDown, this) });
            this.editor.on("click",function () { this.editorClickProxy = $.proxy(auto_complete.rteClicked, this) });
            $('body').on('click', this.bodyClickProxy = $.proxy(auto_complete.rteLostFocus, this));

            $(this.editor.getWin()).on('scroll', auto_complete.rteScroll = $.proxy(function () { auto_complete.cleanUp(true); }, this));
        },
        ...
        lookup: function () {
            //alert($(this.editor.getBody()).find('#autocomplete-searchtext').text());
