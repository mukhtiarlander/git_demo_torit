    ...
    public class MemberCache : CacheLock
    {
        ...
        public static void ClearApiCache(Guid memberId)
        {
            try
            {
                ...
                client.DownloadStringAsync(new Uri(LibraryConfig.URL_TO_CLEAR_MEMBER_CACHE_API + memberId));
            }
            catch (Exception exception)
            {
                ErrorDatabaseManager.AddException(exception, exception.GetType());
        ...
        public static void ClearLeagueMembersApiCache(Guid leagueId)
        {
            ...
            {
                WebClient client = new WebClient();
                client.DownloadStringAsync(new Uri(LibraryConfig.URL_TO_CLEAR_LEAGUE_MEMBER_CACHE_API + leagueId));
            }
            catch (Exception exception)
            {
                ErrorDatabaseManager.AddException(exception, exception.GetType());
        ...
        public static void ClearWebSitesCache(Guid memberId)
        {
            ...
            {
                WebClient client = new WebClient();
                client.DownloadStringAsync(new Uri(LibraryConfig.URL_TO_CLEAR_MEMBER_CACHE + memberId));
                WebClient client1 = new WebClient();
                client1.DownloadStringAsync(new Uri(LibraryConfig.URL_TO_CLEAR_MEMBER_CACHE_API + memberId));
            }
            catch (Exception exception)
            {
                ErrorDatabaseManager.AddException(exception, exception.GetType());
