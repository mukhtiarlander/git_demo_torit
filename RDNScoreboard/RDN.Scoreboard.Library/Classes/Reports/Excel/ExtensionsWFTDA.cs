...
namespace Scoreboard.Library.Classes.Reports.Excel
{
    public static class ExtensionsWFTDA
    {
        ...
        public static ExcelRange SetBoutSummaryAttributesHeader1(this ExcelRange cell)
        {
            cell.SetCenterBottom().SetBorder(ExcelBorderStyle.Thin);
            cell.Style.Font.Size = 9;
            return cell;
        }
        public static ExcelRange SetBoutSummaryAttributesHeader3(this ExcelRange cell)
        {
            cell.SetCenterBottom().SetBorder(ExcelBorderStyle.Thin).SetBackgroundColor(Color.Black).SetFontColor(Color.White);
            cell.Style.TextRotation = 90;
            cell.Style.Font.Size = 9;
            return cell;
        }
