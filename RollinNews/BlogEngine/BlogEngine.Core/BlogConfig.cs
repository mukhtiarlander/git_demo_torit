...
namespace BlogEngine.Core
{
    ...
    public class BlogConfig
    {
        ...
        private static string _chiefRole;
        public static string ChiefRole
        {
            get
            {
                return _chiefRole ?? (_chiefRole = WebConfigurationManager.AppSettings["BlogEngine.ChiefRole"] ?? "chiefs");
            }
        }
        #endregion
