...
namespace BlogEngine.Core.Web
{
    ...
    public class UrlRules
    {
        ...
        public static void RewriteWriteForRollinNews(HttpContext context, string url)
        {
            RewritePhysicalPageGeneric(context, url, "writefor.aspx");
        }
        public static void RewriteWriteForFAQRollinNews(HttpContext context, string url)
        {
            RewritePhysicalPageGeneric(context, url, "writeforfaq.aspx");
        }
        ...
        public static void RewriteOthers(HttpContext context, string url)
        {
            RewritePhysicalPageGeneric(context, url);
        }
        ...
        private static void RewritePhysicalPageGeneric(HttpContext context, string url)
        {
            string query = GetQueryString(context);
            if (query.Length > 0 && query.StartsWith("&"))
            {
            ...
            context.RewritePath(string.Format("{0}{1}{2}", Utils.ApplicationRelativeWebRoot, url.Replace("?", "") + ".aspx", query), false);
        }
