namespace BlogEngine.Core.Web.Controls
{
    ...
    public abstract class BlogBasePage : Page
    {
        ...
        protected override void OnError(EventArgs e)
        {
            ...
            else if (exception != null && !exception.Message.Contains("ThrowMacValidationError") && !exception.Message.Contains("ValidateString") && !exception.Message.Contains("The state information is invalid for this page and might be corrupted"))
