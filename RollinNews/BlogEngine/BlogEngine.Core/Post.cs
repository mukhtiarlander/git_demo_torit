namespace BlogEngine.Core
{
    ...
    public class Post : BusinessBase<Post, Guid>, IComparable<Post>, IPublishable
    {
        ...
        private string authorDerbyName;
        private Guid authorDerbyId;
        ...
        private bool isSavedForApproval;
        #endregion
        ...
        public string BottomLineForConstribution { get; set; }
        ...
        private Guid authorUserId = new Guid();
        public Guid AuthorUserId
        {
            ...
            set
            {
                base.SetValue("AuthorUserId", value, ref this.authorUserId);
            }
        }
        public string AuthorDerbyName
        {
            get
            {
                return this.authorDerbyName;
            }

            set
            {
                base.SetValue("AuthorDerbyName", value, ref this.authorDerbyName);
            }
        }
        public Guid AuthorDerbyId
        {
            get
            {
                return this.authorDerbyId;
            }

            set
            {
                base.SetValue("AuthorDerbyId", value, ref this.authorDerbyId);
            }
        }
        public string InitialImageUrl
        {
            ...
            set
            {
                base.SetValue("InitialImageUrl", value, ref this.initialImageUrl);
            }
        }
        public string MainImageUrl
        {
            ...
            set
            {
                base.SetValue("MainImageUrl", value, ref this.mainImageUrl);
            }
        }
        ...
        public string BaseHost
        {
            get
            {
                return this.Blog.AbsoluteWebRoot.ToString();
            }
        }
        ...
        public bool IsSavedForApproval
        {
            get
            {
                return this.isSavedForApproval;
            }

            set
            {
                base.SetValue("IsSavedForApproval", value, ref this.isSavedForApproval);
            }
        }
        ...
        /// A list of Post.
        /// </returns>
        public static List<PostItem> GetPostsByAuthor(string author, int count)
        {
        ...
        /// A list of Post.
        /// </returns>
        public static List<PostItem> GetPostsByCategory(Guid categoryId, int count)
        {
            var cat = Category.GetCategory(categoryId, Blog.CurrentInstance.IsSiteAggregation);
            return GetPostsByCategory(cat, count);
        }
        public static List<Post> GetPostsByCategoryIPublishable(Guid categoryId)
        {
            var cat = Category.GetCategory(categoryId, Blog.CurrentInstance.IsSiteAggregation);
            return GetPostsByCategoryIPublishable(cat);
        }
        ...
        public static List<PostItem> GetPostsByCategory(Category cat, int count)
        {
            if (cat == null)
            {
                return null;
            }
            var col = new List<PostItem>();
                ...
                foreach (var c in p.Categories)
                {
                    if (Blog.CurrentInstance.IsSiteAggregation)
                    {
                        if (c.Title == cat.Title)
                            col.Add(PostRepository.ToJson((BlogEngine.Core.Post)p));
                    }
                    else
                    {
                        if (c.Title == cat.Title && c.Id == cat.Id)
                            col.Add(PostRepository.ToJson((BlogEngine.Core.Post)p));
                    }
                }
            }
            //var col = Post.ApplicablePosts.Where(p => p.Categories.Contains(cat)).ToList();
            col = col.OrderByDescending(x => x.DateCreated).Take(count).ToList();
            return col;
        }
        public static List<Post> GetPostsByCategoryIPublishable(Category cat)
        {
            if (cat == null)
            {
                return null;
        ...
        public static List<PostItem> GetPostsByTagFront(string tag, int count)
        {
            tag = Utils.RemoveIllegalCharacters(tag);
        ...
        public void UpdateComment(Comment comment)
        {
            ...
            this.Comments[inx].AuthorUserId = comment.AuthorUserId;
