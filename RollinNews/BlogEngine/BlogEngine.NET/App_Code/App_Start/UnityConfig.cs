...
public class UnityConfig
{
    ...
    public static void Register(System.Web.Http.HttpConfiguration config)
    {
        ...
        unity.RegisterType<FundsController>();
        unity.RegisterType<FilesController>();
        unity.RegisterType<SocialController>();
        ...
        unity.RegisterType<RSSFeedController>();
        unity.RegisterType<GamesController>();
        unity.RegisterType<FederationsController>();
        unity.RegisterType<RuleSetController>();
        ...
        unity.RegisterType<IFundsRepository, FundsRepository>(new HierarchicalLifetimeManager());
