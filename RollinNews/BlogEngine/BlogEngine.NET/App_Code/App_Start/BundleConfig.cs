    ...
    public static void RegisterBundles(BundleCollection bundles)
    {
        ...
        bundles.Add(
          new StyleBundle("~/Content/css")
            ...
            .Include("~/Content/jquery-ui-1.10.4.custom.css")
          );
        ...
        bundles.Add(
          new ScriptBundle("~/scripts/blogadmin")
            ...
            .Include("~/scripts/jquery/jquery-ui-1.10.4.custom.min.js")
            .Include("~/scripts/jquery/jquery.ui.timepicker.addon.js")
            ...
            .Include("~/admin/controllers/rssfeeds.js")
            .Include("~/admin/controllers/games.js")
        ...
        bundles.Add(
          new ScriptBundle("~/scripts/wysiwyg")
            ...
            .Include("~/scripts/jquery.form.js")
            .Include("~/scripts/jquery.validate.js")
            .Include("~/editors/tiny_mce_3_5_8/tiny_mce.js")
            .Include("~/scripts/toastr.js")
            .Include("~/scripts/Q.js")
            .Include("~/Scripts/angular.min.js")
            .Include("~/Scripts/angular-route.min.js")
