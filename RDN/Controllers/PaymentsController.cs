...
namespace RDN.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var options = InvoiceFactory.CreateNew().Initalize(LibraryConfig.RDNATION_STORE_ID, "GBP", PaymentProvider.Stripe, LibraryConfig.IsProduction, ChargeTypeEnum.Subscription)
