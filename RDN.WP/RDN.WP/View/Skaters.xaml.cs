...
{
    public partial class Skaters : PhoneApplicationPage
    {
        ...
        void MainPage_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                progressIndicator.Text = "Loading skaters...";
        ...
        void resultListBox_ItemRealized(object sender, ItemRealizationEventArgs e)
        {
            try
            {
                if (!_viewModel.IsLoading && resultListBox.ItemsSource != null && resultListBox.ItemsSource.Count >= _offsetKnob)
                {
                    ...
                    {
                        if ((e.Container.Content as SkaterJson).Equals(resultListBox.ItemsSource[resultListBox.ItemsSource.Count - _offsetKnob]))
                        {
                            _viewModel.LoadPage(lastLetterPulled, lastPagePulled++, PAGE_COUNT);
                        }
                    }
        ...
        private void resultListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                ...
                (App.Current as App).SecondPageObject = (SkaterJson)resultListBox.SelectedItem;// Json.ConvertToString<SkaterJson>();
