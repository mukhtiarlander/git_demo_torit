...
{
    public partial class DuesItemView : PhoneApplicationPage
    {
        ...
        private void EditDues_Click(object sender, EventArgs e)
        {
            NavigationService.Navigate(new Uri("/View/MyLeague/Dues/DuesItemEdit.xaml?did=" + duesItemId + "&dmid=" + duesId, UriKind.Relative));
