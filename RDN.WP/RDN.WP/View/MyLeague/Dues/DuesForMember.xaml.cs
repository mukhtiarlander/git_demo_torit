...
{
    public partial class DuesForMember : PhoneApplicationPage
    {
        ProgressIndicator progressIndicator;
        DuesPortableModel duesModel;
        public DuesForMember()
        {
            InitializeComponent();
        }
        ...
        void PullDues()
        {
            ...
            try
            {
                Task.Run(new Action(() =>
                {
                    duesModel = DuesMobile.DuesForMember(SettingsMobile.Instance.User.MemberId, SettingsMobile.Instance.User.LoginId, SettingsMobile.Instance.User.MemberId);

                    Dispatcher.BeginInvoke(delegate
                    {
                        DuesTitle.Title = duesModel.CurrentMemberDerbyName + " Collecton";
